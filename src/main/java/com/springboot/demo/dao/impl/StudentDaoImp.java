...
import com.springboot.demo.dao.impl.StudentDaoImp;
import com.springboot.demo.mapper.StudentMapperT;
...
public class StudentDaoImp implements StudentDao {
    ...
    public Student queryStudentBySno(String sno) {
        ...
        Object[] args = { sno };
        int[] argTypes = { Types.VARCHAR };
        List<Student> studentList = this.jdbcTemplate.query(sql, args, argTypes, new StudentMapperT());
